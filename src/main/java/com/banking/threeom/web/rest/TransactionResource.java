...
import com.banking.threeom.service.TransactionService;
...
/**
 * REST controller for managing {@link com.banking.threeom.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
public class TransactionResource {
    ...
    public ResponseEntity<TransactionDTO> updateTransaction(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, ENTITY_NAME + transactionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TransactionDTO> getTransaction(@PathVariable Long id) {
        ...
        return transactionDTO.map(response -> ResponseEntity.ok().body(response))
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
    }
